...
// October 28, 2025. Using a retired alias causes every verify request to fail
...
Deno.serve(async (request) => {
  ...
  if (request.method === "OPTIONS") {
    // Browser preflight. 204 + empty body is the canonical answer; CORS
    // headers come from corsHeaders().
